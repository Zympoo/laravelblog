...
class MediaController extends Controller
{
    ...
    public function store(StoreMediaRequest $request)
    {
        ...
        try {
            ...
            if (
                ...
                && !empty($data['mediable_type'])
                && !empty($data['mediable_id'])
            ) {
                Media::query()
    ...
    public function destroy(Media $media)
    {
        try {
            ...
            return back()->with('error', 'Media could not be deleted.');
        }
    }
    ...
    public function restore(int $id)
    {
        try {
            ...
            return back()->with('error', 'Media could not be restored.');
        }
    }
    ...
    public function forceDelete(int $id)
    {
        try {
            ...
            return back()->with('error', 'Media could not be permanently deleted.');
        }
    }
}
